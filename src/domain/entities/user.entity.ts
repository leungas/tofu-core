...
import { IsBoolean, IsDefined, IsEmail, IsInstance, IsNotEmpty, IsOptional, IsPhoneNumber } from "class-validator";
...
export class User {
     ...
     * @type {Date}
     */        
    @Field(() => GraphQLISODateTime, {nullable: true, description: 'The date record is activated'})
    @ApiProperty({
        name: 'activaredOn',
        description: 'The date record is activated',
        type: 'date',
     ...
     * @type {Attachment}
     */           
    @Field(() => Attachment, {nullable: true, description: 'The avatar profile image'})
    @ApiProperty({
        name: 'avatar',
        description: 'The avatar profile image',
        type: Attachment,
     ...
     * @type {Date}
     */         
    @Field(() => GraphQLISODateTime, {nullable: true, description: 'The date record is created'})
    @ApiProperty({
        name: 'createdOn',
        description: 'The date record is created',
        type: 'date',
     ...
     * @type {Date}
     */             
    @Field(() => GraphQLISODateTime, {nullable: true, description: 'The date record is updated'})
    @ApiProperty({
        name: 'lastUpdatedOn',
        description: 'The date record is updated',
        type: 'date',
