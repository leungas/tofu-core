...
export class Workspace {
     ...
     * @type {string}
     */
    @Field(() => String, {nullable: true, description: 'The ID of the workspace'})
    @ApiProperty({
        name: 'id',
        description: 'The ID of the workspace',
        type: 'string',
     ...
     * @type {boolean}
     */            
    @Field(() => Boolean, {defaultValue: true, description: 'The working state of the workspace'})
    @ApiProperty({
        name: 'enabled',
        description: 'The working state of the workspace',
        type: 'boolean',
     ...
     * @type {Team[]}
     */
    @Field(() => [Team], {defaultValue: [], description: "The teams available withon the workspace"})
    @ApiProperty({
        name: 'teams',
        description: 'The teams available withon the workspace',
        type: 'array',
