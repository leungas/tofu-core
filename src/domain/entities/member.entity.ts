...
export class Member {
     ...
     * @author Mark Leung <leungas@gmail.com>
     */
    @Field(() => GraphQLISODateTime, {defaultValue: new Date(), description: 'The date record is created'})
    @ApiProperty({
        name: 'createdOn',
        description: 'The date record is created',
        type: 'date',
     ...
     * @type {boolean}
     */
     @Field(() => Boolean, {nullable: true, description: 'The flag controller the member status in team'})
     @ApiProperty({
         name: 'id',
         description: 'The flag controller the member status in team',
         type: 'boolean',
     ...
     * @author Mark Leung <leungas@gmail.com>
     */
     @Field(() => GraphQLISODateTime, {defaultValue: new Date(), description: 'The date record is updated'})
     @ApiProperty({
         name: 'lastUpdated',
