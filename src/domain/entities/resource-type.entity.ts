...
export class ResourceType {
     ...
     * @type {string]}
     */
     @Field(() => String, {description: 'The resource category owning application'})
     @ApiProperty({
         name: 'application',
         description: 'The resource category owning application',
         type: 'string',
     ...
     */
      ...
      * @type {string}
      */
     @Field(() => String, {description: 'The description for the reosurce we are using'})
     @ApiProperty({
        name: 'description',
        description: 'The description for the reosurce we are using',
        type: 'string',
     ...
     * @type {string[]}
     */
    @Field(() => [String], {defaultValue: ['create', 'read', 'update', 'delete'], description: 'The permissions enabled for the resource'})
    @ApiProperty({
        name: 'permissibles',
        description: 'The permissions enabled for the resource',
        type: 'array',
