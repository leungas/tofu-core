...
export class Preference {
     ...
     * @type {string}
     */
    @Field(() => String, {description: 'The application provided this preference'})
    @ApiProperty({
        name: 'application',
        description: 'The application provided this preference',
        type: 'string',
     ...
     * @type {Date}
     */
     @Field(() => GraphQLISODateTime, {nullable: true, description: 'The date when record is created'})
     @ApiProperty({
         name: 'createdOn',
         description: 'The date when record is created',
         type: 'date',
     ...
     * @type {string}
     */
    @Field(() => String, {description: 'The default value to assign if applicable'})
    @ApiProperty({
        name: 'defaultValue',
        description: 'The default value to assign if applicable',
        type: 'string',
     ...
     * @type {string}
     */
    @Field(() => String, {nullable: true, description: 'The details for the property'})
    @ApiProperty({
        name: 'description',
        description: 'The details for the property',
        type: 'stirng',
     ...
     * @type {boolean}
     */
    @Field(() => Boolean, {nullable: true, defaultValue: false, description: 'Flag to indicate the preference is assignable to a new user'})
    @ApiProperty({
        name: 'isAssignable',
        description: 'Flag to indicate the preference is assignable to a new user',
        type: 'boolean',
     ...
     * @type {Date}
     */
     @Field(() => GraphQLISODateTime, {nullable: true, description: 'The date when record is updated'})
     @ApiProperty({
         name: 'lastUpdatedOn',
