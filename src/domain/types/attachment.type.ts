...
export class Attachment {
     ...
     * @type {string}
     */
    @Field(() => String, {description: 'The asset reference path (URL or assetName)'})
    @ApiProperty({
        name: 'asset',
        description: 'The asset reference path (URL or assetName)',
        type: 'string',
     ...
     * @type {string}
     */
     @Field(() => String, {description: 'The original file name for the attachment'})
     @ApiProperty({
         name: 'orignal',
         description: 'The original file name for the attachment',
         type: 'string',
     ...
     * @type {string}
     */
     @Field(() => String, {description: 'The resource (storage account) for the attachment'})
     @ApiProperty({
         name: 'resource',
         description: 'The resource (storage account) for the attachment',
         type: 'string',
     ...
     * @type {string}
     */
     @Field(() => String, {description: 'The attachment type (either URL or Asset)'})
     @ApiProperty({
         name: 'type',
         description: 'The attachment type (either URL or Asset)',
         type: 'string',
